...
static long g_nORA7DLLRefs = 0l;

static SAMutex ora7LoaderMutex;
...
void AddORA7Support()
{
    throw SAException(SA_Library_Error, SA_Library_Error_ClienVersionOld, -1,
		IDS_CLIENT_VERSION_OLD, 0, 0);
}
