...
protected:
	...
	void * m_pPreHandleExceptionAddlData;
	...
	// return true if target API has told IAS implementation ignores unknow database field types
    ...
    int OutputParamPos(SAParam* pParam) const;
